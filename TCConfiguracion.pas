  ...
  BEGIN
    ...
    BEGIN
          SQL:='INSERT INTO tconfiguracion '+
           ...
           'IVA,DOMICILIO, TELEFONO,IIBB,FECHAINICIO,DIGITOCODIGOBARRA,DIGITOHASTA,CANTIDADIGITOCODIGOBARRA)'+
          ...
          ','+#39+TRIM(PFIVA)+#39+','+#39+TRIM(PFDOMICILIO)+#39+','+#39+TRIM(PFTELEFONO)+#39+','+#39+TRIM(PFIIBB)+#39+
          ','+#39+TRIM(PFFECHAINICIO)+#39+','+#39+trim(PFDIGITOCODIGOBARRA)+#39+
           ','+#39+trim(PFDIGITOHASTA)+#39+','+#39+trim(PFCANTIDADIGITOCODIGOBARRA)+#39+')';
    ...
    END ELSE BEGIN
        ...
        SQL:='UPDATE tconfiguracion  SET '+
           ...
           ', DIGITOCODIGOBARRA='+#39+trim(PFDIGITOCODIGOBARRA)+#39+
            ', DIGITOHASTA='+#39+trim(PFDIGITOHASTA)+#39+
            ', CANTIDADIGITOCODIGOBARRA='+#39+trim(PFCANTIDADIGITOCODIGOBARRA)+#39+
