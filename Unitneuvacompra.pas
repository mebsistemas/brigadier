...
SELF.FDQuery4.SQL.Add('UPDATE TARTICULOS SET STOCKCOMPRA=STOCKCOMPRA + '+FLOATTOSTR(SELF.RxMemoryData1CANTIDAD.Value)+',  STOCK=STOCK  + '+FLOATTOSTR(SELF.RxMemoryData1CANTIDAD.Value)+', COSTO='+FLOATTOSTR(SELF.RxMemoryData1COSTOUNIT.Value)+' WHERE IDARTICULO='+INTTOSTR(SELF.RxMemoryData1IDARTICULO.Value) );
