...
{$ifdef GDIPLUSDRAW}
  SynGdiPlus,
{$endif}
  Vcl.Graphics, Vcl.Controls, Vcl.Dialogs, Vcl.Forms, Vcl.StdCtrls,
  Vcl.ExtCtrls, WinSpool, Vcl.Printers, Vcl.Menus, ShellAPI, RichEdit;
